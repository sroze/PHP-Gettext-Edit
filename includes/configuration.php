...
require_once ROOT_PATH.'includes/configuration/database.php';

Rights_Config::init($sql, $_CONFIG['database']['prefix'].'rights_');

require_once ROOT_PATH.'includes/configuration/user.php';
require_once ROOT_PATH.'includes/configuration/language.php';
require_once ROOT_PATH.'includes/classes/GTE.php';

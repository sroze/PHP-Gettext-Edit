...
/**
 * SQL requests for MySQL for the Rights library.
 *
 * @author Samuel ROZE <samuel.roze@gmail.com>
 * @link http://www.d-sites.com/projets/librairies/Rights
 * @version 0.2
 */
class Rights_SQL_mysql extends Rights_SQL
{
	/**
	...
	public $requests = array(
		...
		'insert_user_right' => 'INSERT INTO %s (`user`, `right`, `context`, `grant`) VALUES (%d, %d, %s, %d)', // #4 must be %s
		...
		'insert_user_group' => 'INSERT INTO %s (`user`, `group`, `context`, `grant) VALUES (%d, %d, %s, %d)', // #4 must be %s
		...
		'insert_context' => 'INSERT INTO %s VALUES(DEFAULT)',

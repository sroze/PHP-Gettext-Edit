<div id="page">
	<div id="contents">
		...
		<form method="POST" action="">
			...
			<p><label>Répertoire du projet</label><input type="text" size="50" name="path_app"<?php
			...
			<p><label>Répertoire des langues</label><input type="text" size="30" name="path_lang"<?php

		<h3><?php echo _('Nom du modèle'); ?></h3>
		...
		<h3><?php echo _('Type de modèle'); ?></h3>
		...
		<h3><?php echo _('Language de programmation'); ?></h3>
		...
		<h3><?php echo _('Mots clés supplémentaires'); ?></h3>
		...
		<h3><?php echo _('Dossiers à analyser'); ?></h3>
		...
		<h3><?php echo _('Types de fichiers'); ?></h3>
